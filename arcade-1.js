...
function gameInit() {
    ...
    allEnemies = [];
    allEnemies.push(
        new Enemy(0, Math.random() * 150 + 40, Math.random() * 100 + 30),
        new Enemy(0, Math.random() * 150 + 100, Math.random() * 100 + 90),
        new Enemy(0, Math.random() * 150 + 160, Math.random() * 100 + 150)
    );
}
